...
_TOOL_LABELS = {
    ...
    "search_tables": "检索数据表",
    "get_relevant_tables": "查找相关数据表",
    "search_entities": "检索本体实体",
    "describe_entity": "查看本体实体",
    "expand_neighbors": "展开语义关系",
    "find_paths": "查找语义路径",
    "find_related_by_type": "查找相关本体实体",
    "get_schema_mapping": "核对结构映射",
    "get_join_paths": "查找关联路径",
    "get_lineage": "查看本体血缘",
    "get_semantic_candidates": "查找语义属性",
    "get_business_context": "构建本体业务上下文",
    "list_defined_classes": "查看已定义业务类",
    "recover_metadata_context": "补充表结构信息",
    "recover_ontology_context": "补充本体语义信息",
}
    ...
    *,
    ...
    if tool_name == "read_skill_resource":
        ...
        return {
            ...
            "agent": agent,
            "parent_id": parent_id,
            "message": f"读取技能资源：{resource_name}",
            "detail": skill_name,
            "metadata": {
